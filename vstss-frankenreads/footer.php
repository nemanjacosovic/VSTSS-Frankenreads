			...
			<footer>
				<div class="wrapper">
					...
					<ul id="vstssfr-footer-partners">
						<li><img src="./img/logos/footer-partner-logo-ksaa.png" height="48" width="auto" title="KSAA" alt="KSAA logo"></li>
						<li><img src="./img/logos/vstss-logo-bw.png" height="56" width="auto" title="VŠTSS Cacak" alt="VŠTSS Cacak logo"></li>
						<li><img src="./img/logos/footer-partner-logo-humanities.png" height="48" width="auto" title="Humanities" alt="Humanities logo"></li>
					</ul>
